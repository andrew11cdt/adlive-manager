...
export enum ADSLIVE_LOADING_SIZE {
  LARGE = "large",
  MEDIUM = "medium",
  SMALL = "small",
...
export type AdsliveLoadingProps = {
  className?: any;
  style?: any;
  size?: ADSLIVE_LOADING_SIZE;
};

const getSizeClassName = (size: ADSLIVE_LOADING_SIZE) => {
  switch (size) {
...
export default function AdsliveLoading({
  ...
  return (
    <>
      ...
      <svg
        className={`${styles.loading} ${getSizeClassName(size) || ""} ${
          className || ""
        }`}
